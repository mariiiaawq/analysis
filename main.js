...
for (let i = 0; i < answer_buttons.length; i += 1) {
    answer_buttons[i].addEventListener('click', function(){
        // kisa_win.style.width = container_main.offsetWidth + 'px';
        // kisa_win.style.height = container_main.offsetHeight + 'px';
        // kisa_zrada.style.width = container_main.offsetWidth + 'px';
        // kisa_zrada.style.height = container_main.offsetHeight + 'px';
